...
{
    public partial class WaterMeterFrm :  Office2007Form
    {
        private DeviceDTO dev;
        private DeviceService ds;
        private Dictionary<String, String> map = new Dictionary<String, String>();
        private const String PARAM_STIME = "waterMeter_stime";
        private const String PARAM_PERIOD = "waterMeter_period";


        public WaterMeterFrm()
        {
            InitializeComponent();
        }

        public WaterMeterFrm(DeviceDTO dev, DeviceService ds)
        {
            InitializeComponent();
            this.dev = dev;
            this.ds = ds;
        ...
        private void PressFrm_Load(object sender, EventArgs e)
        {
